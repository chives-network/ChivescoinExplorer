...
const renderStats = (data: any) => {
  const salesData: DataType[] = [
    ...
    {
      stats: String(data.staking_percentage) + " %",
      title: 'Staking Percentage',
      color: 'info',
...
const AnalyticsMasterNodeCard = (props: any) => {
  // ** Hook
...
export default AnalyticsMasterNodeCard
